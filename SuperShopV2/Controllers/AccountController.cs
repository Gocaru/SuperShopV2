    ...
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> Register(RegisterNewUserViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (user == null)   //Se o user não existe, crio-o
                {
        ...
        [HttpPost]
        [Route("Account/GetCitiesAsync")]       //Quando houver uma Url com este nome ("GetCitiesAsync"), vou executar o código que se segue 
        public async Task<JsonResult> GetCitiesAsync(int countryId)   //Vou passar as cidades em Json; o countryId que recebe, vem da outra combobox
        {
