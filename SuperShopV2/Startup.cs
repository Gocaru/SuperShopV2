...
namespace SuperShopV2
{
    public class Startup
    {
        ...
        {
            //Autenticação na parte da Web
            services.AddIdentity<User, IdentityRole>(cfg =>
            {
                cfg.Tokens.AuthenticatorTokenProvider = TokenOptions.DefaultAuthenticatorProvider;
                cfg.SignIn.RequireConfirmedEmail = true;    //Só vai ser possível fazer o log in quando houver confirmação por email
            ...
            //Autenticação na parte da API
            services.AddAuthentication()
                .AddCookie()
                .AddJwtBearer(cfg =>
                {
                    cfg.TokenValidationParameters = new TokenValidationParameters       //Configuro os parametros dos quais é gerado o Token
                    {
