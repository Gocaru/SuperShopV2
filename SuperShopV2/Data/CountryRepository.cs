...
namespace SuperShopV2.Data
{
    public class CountryRepository : GenericRepository<Country>, ICountryRepository
    {
        ...
        public CountryRepository(DataContext context) : base(context)   //Quando alguém criar um CountryRepository, é preciso dar-lhe um DataContext.
                                                                        //Esse DataContext vai ser enviado para a classe base (a classe-mãe), que é quem trata da ligação à base de dados.
        {
            _context = context;
        }
